# turbojet_small_sizing.py
# 
# Created: Aug 2019, B. Dalman

# Modified from file by:
# May 2015, T. MacDonald 
...
def turbojet_small_sizing(turbojet,mach_number = None, altitude = None, delta_isa = 0, conditions = None):  
    ...
    radial_compressor   = turbojet.radial_compressor
    ...
    axial_turbine      = turbojet.axial_turbine
    ...
    #link the axial turbine to the combustor
    ...
    #link the axial turbine to the radial_compresor
    ...
    axial_turbine.inputs.fan = Data()
    axial_turbine.inputs.fan.work_done = 0.0  
    ...
    thrust.inputs.stag_temp_lpt_exit                       = radial_compressor.outputs.stagnation_temperature
    thrust.inputs.stag_press_lpt_exit                      = radial_compressor.outputs.stagnation_pressure
